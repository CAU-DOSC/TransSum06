...
그리고 그 기회들은 단순히 스택을 쌓는 것이 아닙니다. 시스템 내부에는 커다란 독점 기회가 숨겨져 있습니다. Christensen의 노트에 따르면:

매력적인 이점들은 ... 가치 체인에서 다른 곳으로 이동하거나, 모듈식 제품들이 조립되는 서브 시스템으로 이동합니다. 왜냐하면 더욱 매력적인 이윤 창출을 위해 고급화 전략으로 가게 하는 제조사의 능력을 이끌어내는 것은 모듈식 제품의 아키텍쳐 보다는 서브 시스템에서의 개선이기 때문입니다. 그러므로 서스 시스템은 탈 개인화되고 매력적인 수익을 발생시키게 됩니다.
